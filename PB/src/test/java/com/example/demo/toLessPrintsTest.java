...
public class toLessPrintsTest {
    ...
    public void testHappyPath() {
        ...
        taskVariables.put("Oplacalny", false);
        taskService.complete(op_task.getId(), taskVariables);
        System.out.println("proces 2.1 wykonany, projekt jest nieopłacalny");
        ...
        context.setVariable("description", "Informujemy, że twoje zamówienie zostało odrzucone z powodu zbyt małej ilości sztuk");
